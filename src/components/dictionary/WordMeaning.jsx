const WordMeaning = ({ meaning }) => {
  return (
    <div>
      ...
      <span className="inline-block mb-4-half md:mb-6 text-base md:text-xl text-sonic-silver dark:text-bright-gray">
        Meaning
      </span>
      ...
      {meaning.synonyms.length > 0 && (
        <div className="flex gap-6 mt-6 md:mt-10">
          <span className="text-base md:text-xl text-sonic-silver dark:text-bright-gray">Synonyms</span>
